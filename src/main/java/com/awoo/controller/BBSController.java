...
//    		
//    		//이미지 경로 생성
//    		String path = "C:\\sample\\Saved Pictures" + "ckImage/";	// 이미지 경로 설정(폴더 자동 생성)
//    		String ckUploadPath = path + uid + "_" + fileName;
//    		File folder = new File(path);
//    		System.out.println("이미지 저장 경로 path:"+ckUploadPath);	// 이미지 저장경로 console에 확인
//    		//해당 디렉토리 확인
//    		if(!folder.exists()){
//    			try{
//    				folder.mkdirs(); // 폴더 생성
...
//  // 서버로 전송된 이미지 뿌려주기
	...
	public void ckSubmit(@RequestParam(value="uid") String uid,
	  	...
	  	//서버에 저장된 이미지 경로
	  	String path = "C:\\sample\\Saved Pictures" + "ckImage/";	// 저장된 이미지 경로

...
// 	    	alert(month);
	    	...
	    	let spliteddate = date.split("-");
		    	if(month == spliteddate[1] && year == spliteddate[0]){
		    		...
		    		child[i].style.display = "";
		    		for (var j = 0; j < cnt; j++) {
		    			child[i].children[0].innerHTML = cnt;	
					}
		    	}else {
		    		child[i].style.display = "none";
		    	}
...
// 	    	alert(cnt);
	    	// 이번달 출근 횟수
	    	var countThisMonth = cnt;
	    	// 출근 횟수에서 지각횟수 빼서 정상 근무 횟수 구하기
	    	var normalDay = cnt-${countLate};
	    	
	    	console.log(countThisMonth +"-"+${countLate}+"="+normalDay);
	    	
// 	    	document.getElementById("")
			document.getElementById("normal-commuting").innerHTML = normalDay;
	    });
    </script>

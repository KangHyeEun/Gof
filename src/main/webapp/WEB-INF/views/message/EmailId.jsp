...
<!-- 						</form> -->
		...
		<div id="applypop" style="display: flex;">
				<div class="pop-container">
					<form action="WebCheckId" method="post" enctype="multipart/form-data">
						<div class="pop1">
						...
						<div class="pop1-1">
							...
							<div class="pop2">
								<label for="from">아이디 : </label><input type="text" name="from" id="from" size="40">
								<label for="keyPassword">비밀번호 : </label><input type="text" name="keyPassword" id="keyPassword" size="40">
							</div>
							<div class="pop5">
